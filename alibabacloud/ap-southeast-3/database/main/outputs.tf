...
output "this_db_instance_connection_string" {
  ...
  value       = module.my_sql.this_db_instance_connection_string
}
output "this_db_instance_port" {
  description = "Rds instance public connection string"
  value       = module.my_sql.this_db_instance_port
}
output "this_db_instance_connection_ip_address" {
  description = "Rds instance public connection string's ip address"
  value       = module.my_sql.this_db_instance_connection_ip_address
}
...
output "this_db_database_description" {
  ...
  value       = module.my_sql.this_db_database_description
}
output "this_db_database_id" {
  description = "Rds database id."
  value       = module.my_sql.this_db_database_id
}
output "this_db_database_name" {
  description = "Rds database id."
  value       = module.my_sql.this_db_database_name
}
...
output "this_db_database_account" {
  ...
  value       = module.my_sql.this_db_database_account
}
output "this_db_database_account_privilege" {
  description = "Rds database account privilege."
  value       = module.my_sql.this_db_database_account_privilege
}

output "this_db_database_account_type" {
  description = "Rds database account type."
  value       = module.my_sql.this_db_database_account_type
}

output "this_db_database_account_password" {
  description = "Rds database account password."
  value       = random_password.dbowner.result
  sensitive = true
}